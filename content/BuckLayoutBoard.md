...
![PCBWay](images/buck-layout-board/sponsor-pcbway-logo.png)
...
![PCBWay surface finish options](images/buck-layout-board/pcbway-surface-finish-options.png)

JLCPCB

![JLCPCB surface finish options](images/buck-layout-board/jlcpcb-surface-finish-options.png)
...
![PCBWay advanced manufacturing options](images/buck-layout-board/pcbway-advanced-options.png)
...
![Assembled board photo (front) sent by PCBWay](images/buck-layout-board/assembled-board-front.jpeg)

![Assembled board photo (back) sent by PCBWay](images/buck-layout-board/assembled-board-back.jpeg)
...
![Flying probe continuity test result](images/buck-layout-board/continuity-flying-probe-test.jpeg)
...
![HASL surface finish under microscope](images/buck-layout-board/surface-finish-hasl.jpeg)
...
![Silkscreen quality near vias](images/buck-layout-board/silkscreen-quality.jpeg)

**Edge Cuts:** Clean and sharp with no chips or fragments.

![Board edge cuts](images/buck-layout-board/edge-cuts.jpeg)
...
![Soldermask scratch durability test](images/buck-layout-board/durability-soldermask-scratch-test.jpeg)
