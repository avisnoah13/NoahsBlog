...
heroImage: ./images/quick-test-setup.png
---
...
![MC34063A -5.0V regulator datasheet example](./images/buckboost-regulator-datasheet.png)
...
![Re-routed breadboard circuit with shorter wiring loops](./images/breadboard-rerouted.png)
...
To get the fastest read possible, I connected pins D0-D7 on the MC10319 to the first 8 pins on PORT C on the Teensy. This will enable me to read the port register all at once instead of reading each pin sequentially. To find the first 8 pins of PORT C, I used the core_pins.h file located in Arduino15/packages/teensy/hardware/avr/1.59.0/cores/teensy3.

![Teensy 3.2 PORT C pin mapping from core_pins.h](./images/teensy-portc-pinout.png)
...
![Quick test setup with the ADC, Teensy, and potentiometer](./images/quick-test-setup.png)
...
![MC10319 system timing diagram from the datasheet](./images/clock-timing-diagram.png)
